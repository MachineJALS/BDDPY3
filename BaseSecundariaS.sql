...
-- Configurar el job para ejecutar la consulta cada 6 horas
SELECT cron.schedule(
    'SincronizacionPatrocinadoresPremios',
    '0 */6 * * *', -- Cada 6 horas
    $$ 
    SELECT 
        PA.patrocinador_id, 
    ...
    $$ -- Consulta directa a ejecutar
);

SELECT cron.run_job('SincronizacionPatrocinadoresPremios');
